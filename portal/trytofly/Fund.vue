<script setup>
// Раздел «Матрица даров» — квадратная матрица команды фонда ФСТ.
//
// На портале одна матрица: команда фонда. Матрица общины проекта
// (_claude, заветы, богословие, гости tg:) — внутренняя, портала не касается;
// публично её данные не выходят. Здесь живая команда: роли, поручения,
// ревью, решения.
//
...
<template>
  <div class="j-page">
    ...
    <div id="matrix" class="j-pult__head">
      <div>
        <h1 class="j-pult__title">Матрица даров — команда фонда</h1>
        <p class="j-pult__sub">
