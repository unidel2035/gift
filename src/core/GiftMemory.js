 ...
 *
 * GiftMemory — не архив записей, а единство общины в ἀνάμνησις:
 * каждый дар (нити матрицы W) со-присутствует в каждом акте.
 * Память делает прошлое настоящим — многие лица дышат как одно.
 *
 * Матрица _W [nc × nc] — тварное отражение этого единства:
 * не механическое слияние, а сеть необратимых даров, где вес нити
 * (кто→кому) растёт с каждым актом.
 * Κοινόν как получатель — икона «да будут все едино» по причастию
 * (μέθεξις — соучастие без растворения лиц).
 */
